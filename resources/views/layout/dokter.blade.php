...
<head>
    ...
    <title>@yield('title') - Portal Dokter</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard-dokter') }}">
                <div class="sidebar-brand-icon">
                    <i class="fas fa-user-md"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Portal Dokter</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{ request()->routeIs('dashboard-dokter') ? 'active' : '' }}">
            ...
            <li class="nav-item {{ request()->routeIs('dokter.pasien') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('dokter.pasien') }}">
            ...
            <!-- Nav Item - Ruang -->
            <li class="nav-item {{ request()->routeIs('dokter.ruang.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('dokter.ruang.index') }}">
            ...
            <li class="nav-item {{ request()->routeIs('dokter.obat') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('dokter.obat') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @if($waitingCount > 0)
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('dokter.pasien') }}">
                                    <div class="mr-3">
                                ...
                                @endif
                                <a class="dropdown-item text-center small text-gray-500" href="{{ route('dashboard-dokter') }}">Lihat Dashboard</a>
                            </div>
                        </li>
