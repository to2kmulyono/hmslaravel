        ...
        <form action="{{ route('profile.update', Auth::id()) }}" method="POST" enctype="multipart/form-data" class="user-form">
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    ...
                    <img id="preview-image" src="{{ Auth::user()->foto_user ? asset('storage/foto_user/' . Auth::user()->foto_user) : asset('img/default.jpg') }}" alt="Foto Profil" class="img-fluid mb-3" style="max-width: 70%; height: auto;">
                ...
                <div class="col-md-8">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_user" id="nama_user" class="form-control" value="{{ Auth::user()->nama_user }}" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="no_telepon" id="no_telepon" class="form-control" value="{{ Auth::user()->no_telepon }}" required>
                        </div>
                    </div>
